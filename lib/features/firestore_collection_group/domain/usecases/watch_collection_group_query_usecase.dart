...
class WatchCollectionGroupQueryUseCase {
  WatchCollectionGroupQueryUseCase(this._repository);
  ...
  Stream<Result<List<T>>> call<T>({
    ...
    return _repository.watch(params: params, fromFirestore: fromFirestore);
  }
}
